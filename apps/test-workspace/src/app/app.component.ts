...
import { AuthActions, AuthState, getLoggedIn } from '@test-workspace/auth';
import { LayoutActions, getShowSidenav, CoreState } from '@test-workspace/core';
...
export class AppComponent {
  ...
  constructor(private store: Store<CoreState & AuthState>) {
    /**
